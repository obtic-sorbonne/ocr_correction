...
new_model = "Llama-3.2-3B-ocr-correction-3-instruction-corrected-real-data-full-params"
...
dataset_train = dataset["train"].shuffle(seed=65) #select(range(650)) ### For testing parts
...
training_arguments = SFTConfig(
    ...
    gradient_accumulation_steps=16, # the bigger the better for GPU memory
...
early_stopping_callback = EarlyStoppingCallback(
    early_stopping_patience=7,  # Number of evaluation steps with no improvement to wait
